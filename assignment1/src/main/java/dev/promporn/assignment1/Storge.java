...
public class Storge {
    ...
    public Storge( String toolDetail, String ownerName, String locationName, Boolean borrowed,
            String borrowerName) {
    ...
    public String toString() {
        return "Storge [id=" + id + ", toolDetail=" + toolDetail + ", ownerName=" + ownerName + ", locationName="
